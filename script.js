...
function productCard(p) {
  ...
  return `
    <div class='text-center'>
      ...
      ${p.image ? `<div class='w-full h-60 mb-3 overflow-hidden rounded-lg flex items-center justify-center'><img src='${p.image}' alt='${p.title}' class='w-full h-full object-cover'></div>` : ''}
